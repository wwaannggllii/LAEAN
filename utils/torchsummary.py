...
def summary(model, input_size):
    ...
    print('(For FI) Total PReLUs: {0:,}'.format(total_prelu_layers))
    print('(For FI) Total LeakyReLUs: {0:,}'.format(total_leaky_relu_layers))
