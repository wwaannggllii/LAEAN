...
def save(opt):
    ...
    net_path = os.path.join(os.getcwd(), 'models/modules/'+opt['networks']['G']['which_model']+'_arch.py')
    dump_path = os.path.join(dump_dir, 'network.py')
    shutil.copyfile(net_path, dump_path)
